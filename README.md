...
| `g` | Google | Gemini weekly + 5-hour, shared Claude & GPT pools, hottest account | `omp usage --provider google-antigravity --json` |
...
#AI_USAGE_TOKEN_PLAN_MONTHLY_CREDITS=45000
